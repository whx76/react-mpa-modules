...
/***/ function(module, exports, __webpack_require__) {
	...
	var LayerDemo = function (_React$Component) {
		_inherits(LayerDemo, _React$Component);

		function LayerDemo(props) {
			_classCallCheck(this, LayerDemo);

			return _possibleConstructorReturn(this, (LayerDemo.__proto__ || Object.getPrototypeOf(LayerDemo)).call(this, props));
		}

		_createClass(LayerDemo, [{
			key: 'handleClick',
			value: function handleClick() {
				var optionsLoading = {
					type: 'loading'
				};
				var lodingLayer = new _WrcLayer2.default(optionsLoading);
				setTimeout(function () {
					// 关闭loading
			...
			value: function handleClick2() {
				var optionsFloating = {
					...
					html: _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ className: 'layer-btn sure' },
								'\u6211\u77E5\u9053\u4E86'
							),
							_react2.default.createElement(
								'a',
								{ className: 'layer-btn cancel' },
								'\u53D6\u6D88'
							)
						)
					)
				...
				var floatingLayer = new _WrcLayer2.default(optionsFloating);
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						{ onClick: this.handleClick2, className: 'test-btn' },
						'dialog'
					)
				);
			}
	...
	window.onload = function () {
		_reactDom2.default.render(_react2.default.createElement(LayerDemo, null), document.getElementById('demo'));
	};
...
//# sourceMappingURL=WrcLayer.js.map